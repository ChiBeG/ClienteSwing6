...
public class CadastroClientePrt implements ActionListener {
    ...
    public CadastroClientePrt(MainWindow window, CadastroClienteView cadastroView, CadastroClientePort cadastroService, CEPPort cepService) {
    ...
    private void gerarJSONCliente() {
        JOptionPane.showMessageDialog(cadastroView, "Não implementado ainda!","Exportação de Clientes", JOptionPane.INFORMATION_MESSAGE);

        // Em caso de erro na geração do JSON apresentar uma mensagem
        // JOptionPane.showMessageDialog(view, "Erro na exportação dos clientes","Exportação de Clientes", JOptionPane.ERROR_MESSAGE);
    }
    ...
    private void gerarRelatorioCliente() {
        ...
        JOptionPane.showMessageDialog(cadastroView, "Não implementado ainda!","Relatório de Clientes", JOptionPane.INFORMATION_MESSAGE);

        // Em caso de erro na geração do PDF apresentar uma mensagem
        // JOptionPane.showMessageDialog(view, "Erro na geração do relatório","Relatório de Clientes", JOptionPane.ERROR_MESSAGE);
    }
